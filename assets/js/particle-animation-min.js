var pJS = function (e, a) {
  ...
  this.pJS = {
    ...
    particles: {
      number: { value: 3, density: { enable: !0, value_area: 50 } },
      color: { value: '#ABADBF' },
      shape: {
        type: 'image',
        stroke: { width: 0.05, color: '#ABADBF' },
        polygon: { nb_sides: 5 },
      ...
      size: {
        value: 13,
        random: !1,
        anim: { enable: !0, speed: 4, size_min: 10, sync: !1 },
      },
      line_linked: {
        enable: !0,
        distance: 225,
  ...
  a && Object.deepExtend(i, a),
    ...
    (i.fn.modes.pushParticles = function (e, a) {
      i.tmp.pushing = !0;
      var t = Math.floor(i.canvas.el.width / 20);
      if (i.particles.array.length < t)
        for (var n = 0; n < e; n++)
          i.particles.array.push(
            new i.fn.particle(i.particles.color, i.particles.opacity.value, {
